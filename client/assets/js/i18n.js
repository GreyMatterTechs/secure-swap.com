...
(function(window, undefined) {
	...
	const I18n = function() {
		...
		//	{browser: 'be-x-old',	mailchimp: '',		flag: '',	native: '"беларуская (тарашкевіца)\xE2\x80\x8E"',	english: '(be-tarask compat)',				notes: ''},
			...
			{browser: 'en-au',		mailchimp: 'en',	flag: 'au',	native: 'Australian English',		english: 'English (Australia)',			notes: ''},
			{browser: 'en-bz',		mailchimp: 'en',	flag: 'bz',	native: 'English',					english: 'English (Belize)',			notes: ''},
			{browser: 'en-ca',		mailchimp: 'en',	flag: 'ca',	native: 'Canadian English',			english: 'English (Canada)',			notes: ''},
			{browser: 'en-ie',		mailchimp: 'en',	flag: 'ie',	native: 'English',					english: 'English (Ireland)',			notes: ''},
			{browser: 'en-in',		mailchimp: 'en',	flag: 'in', native: 'Indian English',			english: 'English (India)',				notes: ''},
			{browser: 'en-jm',		mailchimp: 'en',	flag: 'jm',	native: 'English',					english: 'English (Jamaica)',			notes: ''},
			{browser: 'en-nz',		mailchimp: 'en',	flag: 'nz',	native: 'English',					english: 'English (New Zealand)',		notes: ''},
			{browser: 'en-ph',		mailchimp: 'en',	flag: 'ph',	native: 'English',					english: 'English (Philippines)',		notes: ''},
			{browser: 'en-za',		mailchimp: 'en',	flag: 'za',	native: 'English',					english: 'English (South Africa)',		notes: ''},
			{browser: 'en-tt',		mailchimp: 'en',	flag: 'tt',	native: 'English',					english: 'English (Trinidad & Tobago)',	notes: ''},
			...
			{browser: 'en-zw',		mailchimp: 'en',	flag: 'zw',	native: 'Zimbabwe English',			english: 'English (Zimbabwe)',			notes: ''},
			...
			{browser: 'es-ar',		mailchimp: 'es_ES',	flag: 'ar',	native: '',							english: 'Spanish (Argentina)',			notes: ''},
			{browser: 'es-bo',		mailchimp: 'es_ES',	flag: 'bo',	native: '',							english: 'Spanish (Bolivia)',			notes: ''},
			{browser: 'es-cl',		mailchimp: 'es_ES',	flag: 'cl',	native: '',							english: 'Spanish (Chile)',				notes: ''},
			{browser: 'es-co',		mailchimp: 'es_ES',	flag: 'co',	native: '',							english: 'Spanish (Colombia)',			notes: ''},
			{browser: 'es-cr',		mailchimp: 'es_ES',	flag: 'cr',	native: '',							english: 'Spanish (Costa Rica)',		notes: ''},
			{browser: 'es-do',		mailchimp: 'es_ES',	flag: 'do',	native: '',							english: 'Spanish (Dominican Republic)',notes: ''},
			{browser: 'es-ec',		mailchimp: 'es_ES',	flag: 'ec',	native: '',							english: 'Spanish (Ecuador)',			notes: ''},
			{browser: 'es-sv',		mailchimp: 'es_ES',	flag: 'sv',	native: '',							english: 'Spanish (El Salvador)',		notes: ''},
			{browser: 'es-gt',		mailchimp: 'es_ES',	flag: 'gt',	native: '',							english: 'Spanish (Guatemala)',			notes: ''},
			{browser: 'es-hn',		mailchimp: 'es_ES',	flag: 'hn',	native: '',							english: 'Spanish (Honduras)',			notes: ''},
			{browser: 'es-mx',		mailchimp: 'es',	flag: 'mx',	native: '',							english: 'Spanish (Mexico)',			notes: ''},
			{browser: 'es-ni',		mailchimp: 'es_ES',	flag: 'ni',	native: '',							english: 'Spanish (Nicaragua)',			notes: ''},
			{browser: 'es-pa',		mailchimp: 'es_ES',	flag: 'pa',	native: '',							english: 'Spanish (Panama)',			notes: ''},
			{browser: 'es-py',		mailchimp: 'es_ES',	flag: 'py',	native: '',							english: 'Spanish (Paraguay)',			notes: ''},
			{browser: 'es-pe',		mailchimp: 'es_ES',	flag: 'pe',	native: '',							english: 'Spanish (Peru)',				notes: ''},
			{browser: 'es-pr',		mailchimp: 'es_ES',	flag: 'pr',	native: '',							english: 'Spanish (Puerto Rico)',		notes: ''},
			{browser: 'es-es',		mailchimp: 'es_ES',	flag: 'es',	native: '',							english: 'Spanish (Spain)',				notes: ''},
			{browser: 'es-uy',		mailchimp: 'es_ES',	flag: 'uy',	native: '',							english: 'Spanish (Uruguay)',			notes: ''},
			{browser: 'es-ve',		mailchimp: 'es_ES',	flag: 've',	native: '',							english: 'Spanish (Venezuela)',			notes: ''},
			...
			{browser: 'nl',			mailchimp: 'nl',	flag: 'nl',	native: 'Nederlands',				english: 'Dutch',				notes: ''},
			{browser: 'nl-nl',		mailchimp: 'nl',	flag: 'nl',	native: 'Nederlands',				english: 'Dutch',				notes: ''},
		//	{browser: 'nl-informal',mailchimp: 'nl',	flag: '',	native: '"Nederlands (informeel)\xE2\x80\x8E"',	english: 'Dutch',				notes: 'informal address ("je")'},
			...
			{browser: 'os',			mailchimp: '',		flag: '',	native: 'Ирон',						english: 'Ossetic',				notes: 'bug 29091'},
			...
			{browser: 'pl',			mailchimp: 'pl',	flag: 'pl',	native: 'polski',					english: 'Polish',					notes: ''},
			{browser: 'pl-pl',		mailchimp: 'pl',	flag: 'pl', native: 'polski',					english: 'Polish',					notes: ''},
			...
			{browser: 'pt-pt',		mailchimp: 'pt_PT',	flag: 'pt',	native: 'português',				english: 'Portuguese',				notes: ''},
			{browser: 'pt-br',		mailchimp: 'pt_PT',	flag: 'br',	native: 'português do Brasil',		english: 'Brazilian Portuguese',				notes: ''},
			...
			{browser: 'tr',			mailchimp: 'tr',	flag: 'tr',	native: 'Türkçe',					english: 'Turkish',				notes: ''},
			{browser: 'tr-tr',		mailchimp: 'tr',	flag: 'tr',	native: 'Türkçe',					english: 'Turkish',				notes: ''},
		...
		const browserLangLc		= browserLang.replace(/_/g, '-').replace(/^"(.*)"$/, '$1').toLowerCase();
