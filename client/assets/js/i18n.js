...
( function( window, undefined ) {
	...
	var locales = [
		...
		{browser: 'be',			mailchimp: 'be',	flag: '',	native: 'беларуская',				english: ' Belarusian normative',		notes: ''},
	...
	//	{browser: 'be_x_old',	mailchimp: '',		flag: '',	native: '"беларуская (тарашкевіца)\xE2\x80\x8E"',	english: '(be_tarask compat)',				notes: ''},
		...
		{browser: 'bn',			mailchimp: '',		flag: '',	native: 'বাংলা',						english: 'Bengali',						notes: ''},
		...
		{browser: 'it',			mailchimp: 'it',	flag: '',	native: 'italiano',					english: 'Italian',				notes: ''},
		...
		{browser: 'ja',			mailchimp: 'ja',	flag: '',	native: '日本語',						english: 'Japanese',				notes: ''},
	...
	//	{browser: 'nl_informal',mailchimp: 'nl',	flag: '',	native: '"Nederlands (informeel)\xE2\x80\x8E"',	english: 'Dutch',				notes: 'informal address ("je")'},
		...
		{browser: 'ro',			mailchimp: 'ro',	flag: '',	native: 'română',					english: 'Romanian',				notes: ''},
		...
		{browser: 'ru',			mailchimp: 'ru',	flag: '',	native: 'русский',					english: 'Russian',				notes: ''},
	...
	//	{browser: 'zh_classical',mailchimp: 'zh',	flag: 'cn',	native: '文言',						english: 'Classical Chinese/Literary Chinese',				notes: '(see bug 8217)'},
		...
		{browser: 'zh_hans',	mailchimp: 'zh',	flag: '',	native: '"中文（简体）\xE2\x80\x8E"',	english: 'Mandarin Chinese',					notes: '(Simplified Chinese script) (cmn_hans)'},
		{browser: 'zh_hant',	mailchimp: 'zh',	flag: '',	native: '"中文（繁體）\xE2\x80\x8E"',	english: 'Mandarin Chinese',	 				notes: '(Traditional Chinese script) (cmn_hant)'},
