...
( function( window, undefined ) {
	...
	var locales = [
		...
		{browser: 'aln',		mailchimp: '',		flag: 'al',	native: 'Gegë',						english: 'Gheg Albanian',				notes: ''},
		...
		{browser: 'ar_dz',		mailchimp: 'ar',	flag: 'dz',	native: '',							english: 'Arabic (Algeria)',			notes: ''},
		{browser: 'ar_bh',		mailchimp: 'ar',	flag: '',	native: '',							english: 'Arabic (Bahrain)',			notes: ''},
		{browser: 'ar_eg',		mailchimp: 'ar',	flag: 'eg',	native: 'مصرى',						english: 'Arabic (Egypt)',				notes: ''},
		...
		{browser: 'az',			mailchimp: '',		flag: 'az',	native: 'Azərbaycan dili',			english: 'Azerbaijani',					notes: ''},
		...
		{browser: 'be',			mailchimp: 'be',	flag: 'by',	native: 'беларуская',				english: ' Belarusian normative',		notes: ''},
	...
	//	{browser: 'be_x_old',	mailchimp: '',		flag: '',	native: '"беларуская (тарашкевіца)\xE2\x80\x8E"',	english: '(be_tarask compat)',				notes: ''},
		...
		{browser: 'da',			mailchimp: 'da',	flag: 'dk',	native: 'Dansk',					english: 'Danish',						notes: ''},
		...
		{browser: 'en_au',		mailchimp: 'en',	flag: 'au',	native: 'Australian English',		english: 'English (Australia)',			notes: ''},
		...
		{browser: 'fi',			mailchimp: 'fi',	flag: 'fi',	native: 'Suomi',					english: 'Finnish',				notes: ''},
		...
		{browser: 'it-ch',		mailchimp: 'it',	flag: 'ch',	native: '',							english: 'Italian (Switzerland)',				notes: ''},
	...
	//	{browser: 'nl_informal',mailchimp: 'nl',	flag: '',	native: '"Nederlands (informeel)\xE2\x80\x8E"',	english: 'Dutch',				notes: 'informal address ("je")'},
		...
		{browser: 'pt_br',		mailchimp: 'pt',	flag: 'br',	native: 'português do Brasil',		english: 'Brazilian Portuguese',				notes: ''},
		...
		{browser: 'ro_mo',		mailchimp: 'ro',	flag: 'md',	native: '',							english: 'Romanian (Moldavia)',				notes: ''},
		...
		{browser: 'ru_mo',		mailchimp: 'ru',	flag: 'md',	native: '',							english: 'Russian (Moldavia)',				notes: ''},
		{browser: 'rue',		mailchimp: '',		lag: '',	native: 'русиньскый',				english: 'Rusyn',				notes: ''},
		{browser: 'rup',		mailchimp: '',		lag: '',	native: 'Armãneashce',				english: 'Aromanian',				notes: ''},
		{browser: 'ruq',		mailchimp: '',		lag: '',	native: 'Vlăheşte',					english: 'Megleno-Romanian',				notes: '(multiple scripts - defaults to Latin)'},
	...
	//	{browser: 'zh_classical',mailchimp: 'zh',	flag: 'cn',	native: '文言',						english: 'Classical Chinese/Literary Chinese',				notes: '(see bug 8217)'},
		...
		{browser: 'zh_mo',		mailchimp: 'zh',	flag: 'mo',	native: '"中文（澳門）\xE2\x80\x8E"',	english: 'Chinese (Macau)',	 					notes: ''},
		{browser: 'zh_my',		mailchimp: 'zh',	flag: 'my',	native: '"中文（马来西亚）\xE2\x80\x8E"',	english: 'Chinese (Malaysia)',	 				notes: ''},
		{browser: 'zh_sg',		mailchimp: 'zh',	flag: 'sg',	native: '"中文（新加坡）\xE2\x80\x8E"',	english: 'Chinese (Singapore)',	 				notes: ''},
	...
	var selectLanguage = function(code) {
	...
	$('#i18n-menu').off('click.lang').on('click.lang', 'a', function (e) {
		e.preventDefault();
		selectLanguage($(this).attr('data-i18n-locale'));
		return false;
	});
